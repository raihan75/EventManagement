		...
		<div class="container">
			<div class="about-top-grids">
				<div class="col-md-7 about-top-left">
					<h4>Vivamus non auctor tellus, sit amet efficitur risus. Morbi erat ante, lobortis aliquam porttitor nec</h4>
					<h5>Aliquam erat volutpat. Vestibulum sem felis, gravida a velit vitae</h5>
					<p>Aliquam erat volutpat. Vestibulum sem felis, gravida a velit vitae, convallis tempus neque. Ut justo lacus, iaculis ut orci vitae, ullamcorper sagittis lectus. Pellentesque a urna et felis consectetur molestie. Fusce placerat velit ut augue pharetra
					<span>ut imperdiet libero suscipit. Phasellus tempor scelerisque magna non finibus. Fusce fringilla elit mattis turpis dictum venenatis. Nulla tempor sapien non erat congue vestibulum. </span>
					</p>
				</div>
	...
	<div class="about-bottom jarallax">
		<div class="container">
			<div class="about-bottom-info">
				<h4>Sed sapien nisi, mollis ut ante eget, vulputate tristique turpis. Pellentesque sed nibh venenatis elit elementum placerat. </h4>
