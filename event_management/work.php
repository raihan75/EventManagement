...
<html lang="en">
<head>
<title>Events Planning  a Wedding Category Flat Bootstrap Responsive Website Template | Work :: w3layouts</title>
<!-- custom-theme -->
							...
							<ul id="m_nav_list" class="m_nav menu__list">
								...
								<li class="dropdown m_nav_item"  id="moble_nav_item_7"><a href="#" class="dropdown-toggle link link--kumya" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color: #333;">Events <span class="caret"></span></a>
						          <ul class="dropdown-menu">
						            ...
						            <li><a href="#">Termenic Ceremony</a></li>
						          </ul>
						        </li>
								...
								<li class="m_nav_item active" id="moble_nav_item_4"> <a href="work.php" class="link link--kumya"><i class="fa fa-building-o" aria-hidden="true"></i><span data-letters="Our Work">Our Work</span></a></li>
			...
			<div class="agileits_w3three_nav">
				<div class="agileits_w3three_nav_left">
					<ul>
						...
						<li class="active"><a href="work.php">Our Work</a></li>
