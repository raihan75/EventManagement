			...
			<div class="container">
				<div class="header-left">
					<div class="w3layouts-logo">
						<h1>
							<a href="index.php">"Reception Management"</a>
						</h1>
					</div>
				</div>
			</div>
								...
								<ul class="nav navbar-nav">
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											<li><a href="event_management/wedding/index.php">Wedding</a></li>
									...
									<li><a href="service.php">Our Work</a></li>
			...
			<div class="welcome-agileitsrow">
				<div class="col-md-8 welcome-left">
					...
					<div class="col-md-8 col-sm-8 welcome-w3ls-text">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras rutrum iaculis enim, non convallis felis mattis at. Donec fringilla lacus eu pretium rutrum. Cras aliquet congue ullamcorper. Etiam mattis eros eu ullamcorper volutpat. Proin ut dui a urna efficitur varius.
						<span>Quisque molestie cursus mi et congue consectetur adipiscing elit cras rutrum iaculis enim, Lorem ipsum dolor sit amet, non convallis felis mattis at.</span>
						Vivamus facilisis, ante in cursus ullamcorper, ipsum neque aliquet odio, dignissim varius urna nibh vitae lectus. Aenean vestibulum ipsum scelerisque dui ultricies semper.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
		...
		<div class="container">
			...
			<div class="w3-agileits-services-grids">
				...
				<div class="col-md-6 w3-agile-services-right">
					<h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ut magna vitae sapien auctor pharetra nec in erat. In nisl nibh, maximus at quam eget, aliquet viverra lorem.</h5>
					<p>Pellentesque suscipit, ante et viverra malesuada, ante tellus ornare enim, sed convallis mauris diam sed nisl. Donec eleifend et lorem posuere semper. Aliquam id placerat mauris, at mollis neque. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vivamus in faucibus lectus. Quisque convallis tempus leo et sagittis. <span>Vestibulum non sem pharetra, suscipit turpis eu, ultrices justo. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla tincidunt urna convallis lorem sagittis, eu vehicula elit iaculis.</span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
			...
			<div class="agile_banner_bottom_grids">
				<div class="agile_events_grid">
					...
					<div class="agile_events_grid_pos agile_events_grid_pos1">
						...
						<h4><a href="single.php">nunc malesuada lacinia</a></h4>
				...
				<div class="agile_events_grid">
					...
					<div class="agile_events_grid_pos_sub agile_events_grid_pos1">
						...
						<h4><a href="single.php">consequat dictum sodales</a></h4>
						<p>Nunc non maximus augue, sit amet dictum diam. Etiam ultrices hendrerit sapien, 
							id volutpat tortor viverra et.</p>
					</div>
				...
				<div class="agile_events_grid">
					...
					<div class="agile_events_grid_pos agile_events_grid_pos1">
						...
						<h4><a href="single.php">ultrices hendrerit amet</a></h4>
						<p>Nunc non maximus augue, sit amet dictum diam. Etiam ultrices hendrerit sapien, 
							id volutpat tortor viverra et.</p>
					</div>
					<div class="agileits_w3layouts_events_grid_social">
